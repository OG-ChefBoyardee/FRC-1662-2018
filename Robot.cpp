...
WPI_TalonSRX *drive_right_a, *drive_right_b, *drive_left_a, *drive_left_b;
WPI_TalonSRX *intake;
WPI_TalonSRX *extra;
...
drive_right_a  = new WPI_TalonSRX(8);
drive_right_b  = new WPI_TalonSRX(9);
drive_left_a   = new WPI_TalonSRX(1);
drive_left_b   = new WPI_TalonSRX(2);

intake 		   = new WPI_TalonSRX(4);
shooter 	   = new WPI_TalonSRX(7);
climber        = new WPI_TalonSRX(6);
ball_mover     = new WPI_TalonSRX(3);
extra		   = new WPI_TalonSRX(5);
...
{
drive_right_a->SetNeutralMode (NeutralMode::Brake);
drive_right_b->SetNeutralMode (NeutralMode::Brake);
drive_left_a ->SetNeutralMode (NeutralMode::Brake);
drive_left_b ->SetNeutralMode (NeutralMode::Brake);
}
if
(
	autoSelected == GearM
...
//changes the mode of drive TalonSRX from Brake to Cost and from Cost to Brake
...

{
	...
	drive_right_a  ->SetNeutralMode (NeutralMode::Coast);
	drive_right_b  ->SetNeutralMode (NeutralMode::Coast);
	drive_left_a   ->SetNeutralMode (NeutralMode::Coast);

	drive_left_b   ->SetNeutralMode (NeutralMode::Coast);
...

{
	...
	drive_right_b  ->CSetNeutralMode (NeutralMode::Brake);

	drive_left_a   ->CSetNeutralMode (NeutralMode::Brake);

	drive_left_b   ->CSetNeutralMode (NeutralMode::Brake);

	climber        ->CSetNeutralMode (NeutralMode::Brake);
